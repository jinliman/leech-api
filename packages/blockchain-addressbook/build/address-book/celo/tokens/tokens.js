...
var _tokens = {
  ...
  WETH: {
    ...
    chainId: 42220,
    decimals: 18,
    logoURI: 'https://pancakeswap.finance/images/tokens/0x122013fd7dF1C6F636a5bb8f03108E876548b455.svg',
    website: 'https://ethereum.org/',
    description: 'The native currency that flows within the Ethereum economy is called Ether (ETH). Ether is typically used to pay for transaction fees called Gas, and it is the base currency of the network.',
  },
  DAIV1: {
  ...
  DAI: {
    ...
    chainId: 42220,
    decimals: 18,
    logoURI: 'https://pancakeswap.finance/images/tokens/0xE4fE50cdD716522A56204352f00AA110F731932d.svg',
    website: 'https://makerdao.com/en/',
    description: 'DAI is an Ethereum-based stablecoin (stable-price cryptocurrency) whose issuance and development is managed by the Maker Protocol and the MakerDAO decentralized autonomous organization.',
  },
  SUSHIV2: {
  ...
  USDC: {
    ...
    chainId: 42220,
    decimals: 6,
    logoURI: 'https://pancakeswap.finance/images/tokens/0xef4229c8c3250C675F21BCefa42f58EfbfF6002a.svg',
  ...
  USDT: {
    ...
    chainId: 42220,
    decimals: 6,
    logoURI: 'https://pancakeswap.finance/images/tokens/0x88eeC49252c8cbc039DCdB394c0c2BA2f1637EA0.svg',
  ...
  MOBI: {
    ...
    chainId: 42220,
    decimals: 18,
    logoURI: 'https://pancakeswap.finance/images/tokens/0x73a210637f6F6B7005512677Ba6B3C96bb4AA44B.svg',
